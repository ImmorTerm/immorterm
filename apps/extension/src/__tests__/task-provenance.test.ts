...
import { getLegacyTaskProjectIds, getStableProjectId } from "../services/memory/project-identity";
...
describe("canonical task project identity", () => {
	it("prefers the saved project slug and exposes the former remote id for migration", () => {
		...
		execFileSync("git", ["remote", "add", "origin", "git@github.com:FLAM-Fashion/flam.git"], {
			cwd: workspace,
		});
