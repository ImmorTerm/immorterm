...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_3350: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_3346: (a: number, b: number, c: number, d: number) => void;
